...
function Navigation() {
  ...
  return (
    <div className="">
      <div class="flex h-16 items-center justify-between font-aileronRegular overflow-hidden text-themeGray bg-themeNavy fixed w-[100%] z-30 md:h-full md:flex-col md:w-16 dark:bg-themeGray dark:text-themeNavy">
